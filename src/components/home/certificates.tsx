  ...
  return (
    <div className='w-full min-h-screen p-4 pt-28' id='certificates'>
      ...
      <div className='flex flex-wrap gap-8 items-top justify-center'>
        <div className='flex flex-col items-center border border-stone-500 hover:border-[#6DD5FA] rounded-md hover:scale-105'>
        ...
        <div className='flex flex-col items-center border border-stone-500 rounded-md hover:border-[#6DD5FA] hover:scale-105'>
          <Image
            alt='Certificate'
        ...
        {/* <div className='flex flex-col items-center rounded-md border border-stone-500 hover:border-[#6DD5FA] hover:scale-105'>
          <Image
            alt='Certificate'
